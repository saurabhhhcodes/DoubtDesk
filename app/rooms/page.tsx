          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <Link
                  href="/"
                  className="inline-flex items-center gap-2 text-slate-400 text-xs font-black uppercase tracking-widest hover:text-white underline underline-offset-4 transition-all"
                >
          ...
          <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 text-center space-y-4">
            ...
            <p className="text-slate-500 max-w-md mx-auto font-medium">
              ...
              {appUser?.role === "teacher"
                ...
                : " Ask your teacher for the invite code to join."}
            </p>
            <button
              onClick={() =>
                appUser?.role === "teacher"
            ...
            {recommended.length > 0 && (
              <div className="space-y-6 pt-6 border-t border-white/5">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-black uppercase tracking-tight italic flex items-center gap-3">
                    <Sparkles className="w-6 h-6 text-cyan-400" /> Recommended
                    for {appUser?.year} at {appUser?.university}
                  </h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#0f172a] border border-white/10 w-full max-w-lg rounded-[3rem] p-10 shadow-2xl space-y-8 animate-in zoom-in-95 duration-300">
            <div className="space-y-2">
              <h2 className="text-4xl font-black italic uppercase tracking-tighter">
                Spawn <span className="text-blue-500">Classroom</span>
              </h2>
              <p className="text-slate-400 font-medium">
                Define your new academic workspace.
              </p>
            </div>
            ...
            <form onSubmit={handleCreateRoom} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setCreateData({ ...createData, year: e.target.value })
                  }
                ...
                >
                  <option className="bg-[#0f172a]" value="1st Year">
                    1st Year
                  </option>
                  <option className="bg-[#0f172a]" value="2nd Year">
                    2nd Year
                  </option>
                  <option className="bg-[#0f172a]" value="3rd Year">
                    3rd Year
                  </option>
                  <option className="bg-[#0f172a]" value="Final Year">
                    Final Year
                  </option>
                </select>
              </div>
      ...
      {isJoinModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 backdrop-blur-xl bg-[#020617]/80 animate-in fade-in duration-300">
          <div className="bg-[#0f172a] border border-white/10 w-full max-w-lg rounded-[3rem] p-10 shadow-2xl space-y-8 animate-in zoom-in-95 duration-300">
            <div className="space-y-2">
              <h2 className="text-4xl font-black italic uppercase tracking-tighter">
                Enter <span className="text-blue-500">Class</span>
              </h2>
              <p className="text-slate-400 font-medium">
                Input your unique invitation code.
              </p>
            </div>
          ...
          <div className="pt-6 border-t border-white/10 flex items-center justify-between">
            <div className="flex items-center gap-4 text-slate-400 text-[10px] font-black uppercase tracking-widest">
              <span className="flex items-center gap-1.5">
                <Calendar className="w-3.5 h-3.5" /> {room.year}
              </span>
              <span className="flex items-center gap-1.5">
